 ...
 */
$osW_DDM4=new osWFrame\Core\DDM4($osW_Template, 'weberp_variablen', $ddm4_object);
...
if (in_array($ddm_navigation_id, [1])) {
	 ...
	 * Send: Vorsicht
	 */
	$ddm4_elements['send']['vis2_weberp_label']=[];
	$ddm4_elements['send']['vis2_weberp_label']['module']='label';
	$ddm4_elements['send']['vis2_weberp_label']['title']='Vorsicht';
	$ddm4_elements['send']['vis2_weberp_label']['options']=[];
	$ddm4_elements['send']['vis2_weberp_label']['options']['label']='In diesem Bereich nur arbeiten, wenn sie wissen was sie tun! Sie können mit falschen Einstellungen die Software zerstören!';
}
/*
