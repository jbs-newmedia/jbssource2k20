...
$ddm4_elements['data']['kunde_firma_anrede']['options']['data']=$VIS2_WebERP_Verwaltung->getKundenAnreden('anrede_titel');
...
$ddm4_elements['data']['kunde_anrede']['options']['data']=$VIS2_WebERP_Verwaltung->getKundenAnreden('anrede_titel');;
...
$ddm4_elements['data']['kunde_land']['options']['data']=$VIS2_WebERP_Verwaltung->getKundenLaender('land_titel');
