 ...
 * init
 */
$__datatable_table='weberp_kunde_konto';
...
CREATE TABLE :table: (
	...
	konto_iban varchar(32) NOT NULL DEFAULT \'\',
	konto_bank varchar(128) NOT NULL DEFAULT \'\',
	konto_bic varchar(32) NOT NULL DEFAULT \'\',
	konto_ispublic tinyint(1) unsigned NOT NULL DEFAULT 0,
	konto_create_time int(11) unsigned NOT NULL DEFAULT 0,
	konto_create_user_id int(11) unsigned NOT NULL DEFAULT 0,
	konto_update_time int(11) unsigned NOT NULL DEFAULT 0,
	konto_update_user_id int(11) unsigned NOT NULL DEFAULT 0,
	PRIMARY KEY (konto_id),
	KEY kunde_id (kunde_id),
	KEY mandant_id (mandant_id),
	KEY konto_ispublic (konto_ispublic),
	KEY konto_create_time (konto_create_time),
	KEY konto_create_user_id (konto_create_user_id),
	KEY konto_update_time (konto_update_time),
	KEY konto_update_user_id (konto_update_user_id)
