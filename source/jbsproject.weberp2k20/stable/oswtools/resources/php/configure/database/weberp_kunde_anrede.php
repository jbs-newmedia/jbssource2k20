 ...
 * init
 */
$__datatable_table='weberp_kunde_anrede';
...
if (($av_tbl==0)&&($ab_tbl==0)) {
	...
	$QwriteData->prepare('
CREATE TABLE :table: (
	anrede_id int(11) unsigned NOT NULL AUTO_INCREMENT,
	mandant_id int(11) unsigned NOT NULL DEFAULT 0,
	anrede_titel varchar(16) NOT NULL DEFAULT \'\',
	anrede_ispublic tinyint(1) unsigned NOT NULL DEFAULT 0,
	anrede_create_time int(11) unsigned NOT NULL DEFAULT 0,
	anrede_create_user_id int(11) unsigned NOT NULL DEFAULT 0,
	anrede_update_time int(11) unsigned NOT NULL DEFAULT 0,
	anrede_update_user_id int(11) unsigned NOT NULL DEFAULT 0,
	PRIMARY KEY (anrede_id),
	KEY mandant_id (mandant_id),
	KEY anrede_ispublic (anrede_ispublic),
	KEY anrede_create_time (anrede_create_time),
	KEY anrede_create_user_id (anrede_create_user_id),
	KEY anrede_update_time (anrede_update_time),
	KEY anrede_update_user_id (anrede_update_user_id)
