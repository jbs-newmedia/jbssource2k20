 ...
 * init
 */
$__datatable_table='weberp_schreiben';
...
CREATE TABLE :table: (
	schreiben_id int(11) unsigned NOT NULL AUTO_INCREMENT,
	mandant_id int(11) unsigned NOT NULL DEFAULT 0,
	schreiben_zeile_1 varchar(128) NOT NULL DEFAULT \'\',
	schreiben_zeile_2 varchar(128) NOT NULL DEFAULT \'\',
	schreiben_zeile_3 varchar(128) NOT NULL DEFAULT \'\',
	schreiben_zeile_4 varchar(128) NOT NULL DEFAULT \'\',
	schreiben_datum varchar(8) NOT NULL DEFAULT \'\',
	schreiben_titel varchar(128) NOT NULL DEFAULT \'\',
	schreiben_text text NOT NULL DEFAULT \'\',
	schreiben_create_time int(11) unsigned NOT NULL DEFAULT 0,
	schreiben_create_user_id int(11) unsigned NOT NULL DEFAULT 0,
	schreiben_update_time int(11) unsigned NOT NULL DEFAULT 0,
	schreiben_update_user_id int(11) unsigned NOT NULL DEFAULT 0,
	PRIMARY KEY (schreiben_id),
	KEY mandant_id (mandant_id),
	KEY schreiben_datum (schreiben_datum),
	KEY schreiben_create_time (schreiben_create_time),
	KEY schreiben_create_user_id (schreiben_create_user_id),
	KEY schreiben_update_time (schreiben_update_time),
	KEY schreiben_update_user_id (schreiben_update_user_id)
