 ...
 * init
 */
$__datatable_table='weberp_kunde_land';
...
CREATE TABLE :table: (
	...
	land_titel varchar(64) NOT NULL DEFAULT \'\',
	land_ispublic tinyint(1) unsigned NOT NULL DEFAULT 0,
	land_create_time int(11) unsigned NOT NULL DEFAULT 0,
	land_create_user_id int(11) unsigned NOT NULL DEFAULT 0,
	land_update_time int(11) unsigned NOT NULL DEFAULT 0,
	land_update_user_id int(11) unsigned NOT NULL DEFAULT 0,
	PRIMARY KEY (land_id),
	KEY mandant_id (mandant_id),
	KEY land_ispublic (land_ispublic),
	KEY land_create_time (land_create_time),
	KEY land_create_user_id (land_create_user_id),
	KEY land_update_time (land_update_time),
	KEY land_update_user_id (land_update_user_id)
