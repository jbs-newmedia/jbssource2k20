 ...
 * init
 */
$__datatable_table='weberp_artikel_mwst';
...
if (($av_tbl==0)&&($ab_tbl==0)) {
	...
	$QwriteData->prepare('
CREATE TABLE :table: (
	mwst_id int(11) unsigned NOT NULL AUTO_INCREMENT,
	mandant_id int(11) unsigned NOT NULL DEFAULT 0,
	mwst_titel varchar(16) NOT NULL DEFAULT \'\',
	mwst_ispublic tinyint(1) unsigned NOT NULL DEFAULT 0,
	mwst_create_time int(11) unsigned NOT NULL DEFAULT 0,
	mwst_create_user_id int(11) unsigned NOT NULL DEFAULT 0,
	mwst_update_time int(11) unsigned NOT NULL DEFAULT 0,
	mwst_update_user_id int(11) unsigned NOT NULL DEFAULT 0,
	PRIMARY KEY (mwst_id),
	KEY mandant_id (mandant_id),
	KEY mwst_ispublic (mwst_ispublic),
	KEY mwst_create_time (mwst_create_time),
	KEY mwst_create_user_id (mwst_create_user_id),
	KEY mwst_update_time (mwst_update_time),
	KEY mwst_update_user_id (mwst_update_user_id)
